export const TYPES_COMPONENTS = [
    {label: 'Store Procedure', value: 'store_procedure', path: 'db/store_procedures/', mdx_title: 'SQL SP', emoji: '📜'},
    {label: 'Script SQL', value: 'script_sql', path: 'db/scripts/', mdx_title: 'SQL', emoji: '🟪'},
